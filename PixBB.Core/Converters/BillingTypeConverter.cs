...
/// <summary>
/// Classe para conversão do enumerador <see cref="BillingType"/> para json e vice-versa.
/// </summary>
public class BillingTypeConverter : JsonConverter
{
    /// <summary>
    ...
    public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
    {
        ...
        return value switch
        {
            "cobv" => BillingType.CobrancaComVencimento,
            _ => BillingType.CobrancaImediata
        };
    }
    ...
    {
        var locale = (BillingType) value;
        switch (locale)
        {
            case BillingType.CobrancaComVencimento:
                writer.WriteValue("cobv");
                break;
            case BillingType.CobrancaImediata:
            default:
